...
// import 'package:wonders/ui/screens/menu/about_dialog_content.dart';

import 'package:wonders/src/controller.dart'
    show $strings, settingsLogic, wondersLogic;
...
class HomeMenu extends StatelessWidget {
  ...
  void _handleTimelinePressed(BuildContext context) =>
      context.push(ScreenPaths.timeline(data.type));
  ...
  Widget _buildGridBtn(BuildContext context, WonderData btnData) {
    final bool isSelected = btnData == data;
    return AspectRatio(
      aspectRatio: 1,
      child: Container(
