        ...
        return Stack(
          ...
          children: types.map(
            (t) {
              ...
              final double pxToYrRatio = totalYrs /
              ...
              final int wonderYrs = data.endYr - data.startYr;
              final int yrsFromStart =
                  data.startYr - wondersLogic.timelineStartYear;
              double startPx = yrsFromStart / pxToYrRatio;
              double sizePx = wonderYrs / pxToYrRatio;
              if (sizePx < minSize) {
                final double yearDelta = (minSize - sizePx) / 2;
                sizePx = minSize;
                startPx -= yearDelta;
              }
