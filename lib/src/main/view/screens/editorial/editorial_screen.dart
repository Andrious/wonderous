...
class _WonderEditorialScreenState extends State<WonderEditorialScreen> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, constraints) {
      final bool shortMode = constraints.biggest.height < 700;
      final double illustrationHeight = shortMode ? 250 : 280;
      final double minAppBarHeight = shortMode ? 80 : 120;
      final double maxAppBarHeight = shortMode ? 400 : 500;
          ...
          child: Stack(
            children: [
                  ...
                  builder: (_, value, __) {
                    return Container(
                      color: widget.data.type.bgColor
                          .withOpacity(_scrollPos.value > 1000 ? 0 : 1),
                    );
                  },
                ),
              ),
              ...
              SizedBox(
                ...
                child: ValueListenableBuilder<double>(
                  ...
                  builder: (_, value, child) {
                    ...
                    final double opacity = (1 - value / 700).clamp(0, 1);
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: ValueListenableBuilder<double>(
                      valueListenable: _scrollPos,
                      builder: (_, value, child) {
                        final double offsetAmt = max(0, value * .3);
              ...
              AnimatedBuilder(
                  ...
                  child: const BackBtn(icon: AppIcons.north).safe()),
            ],
          ),
        ),
      );
