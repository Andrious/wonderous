...
class _CircularTitleBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const double barSize = 100; // the actual size of this widget
    const double barTopPadding = 40; // negative space at the top of the bar
    const double circleSize =
        190; // circle is bigger than bar, and overhangs it
...
class _AnimatedCircleWithTextState extends State<_AnimatedCircleWithText>
  ...
  Widget _buildCircularText(String title) {
    final textStyle = $styles.text.monoTitleFont
        .copyWith(fontSize: 22, color: $styles.colors.accent1);
    return CircularText(
