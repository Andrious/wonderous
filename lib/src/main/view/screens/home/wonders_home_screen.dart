...
// import 'package:wonders/ui/screens/menu/menu.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _handleOpenMenuPressed() async {
    setState(() => _isMenuOpen = true);
    final WonderType? pickedWonder =
  ...
  Future<void> _showDetailsPage() async {
  ...
  Future<void> _startDelayedFgFade() async {
        ...
        child: Stack(
          children: [
            ...
            Stack(children: [
              ...
              BottomCenter(
                child: _buildSwipeableBgGradient(
                    currentWonder.type.bgColor.withOpacity(.65)),
              ),
              ...
              BottomCenter(
                child: _buildSwipeableBgGradient(
                    currentWonder.type.bgColor.withOpacity(1)),
              ),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    AppPageIndicator(
                                      ...
                                      dotSize: 8,
                                      onDotPressed:
                                          _handlePageIndicatorDotPressed,
                                      semanticPageTitle:
                                          $strings.homeSemanticWonder,
                                    ),
                                  ],
                                ),
                              ),
  ...
  Widget _buildMgChild(_, index) {
    ...
    final bool isShowing = _isSelected(wonderType);
  ...
  Widget _buildSwipeableArrowBg() {
    return _swipeController.buildListener(
      builder: (swipeAmt, _, child) {
        final double heightFactor = .5 + .5 * (1 + swipeAmt * 4);
