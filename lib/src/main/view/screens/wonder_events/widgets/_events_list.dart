...
class _EventsListState extends State<_EventsList> {
            ...
            AnimatedBuilder(
              ...
              builder: (_, __) {
                ...
                if (_scroller.hasClients) {
                  const double blurStart = 50;
                  const double maxScroll = 150;
                  final double scrollPx = _scroller.position.pixels - blurStart;
  ...
  Widget _buildScrollingList() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          const IgnorePointer(child: Gap(WonderEvents._topHeight)),
          Container(
            decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                ...
                const CompassDivider(isExpanded: true),
