...
class _ScalingViewportState extends State<_ScrollingViewport> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, constraints) {
      ...
      final double size = controller.calculateContentHeight();
            ...
            children: [
              Column(
                children: [
                  ...
                  Expanded(
                    child: _buildScrollingArea(
                        vtPadding, size, context, constraints),
                  ),
  ...
  AnimatedBuilder _buildAnimatedEraText(BuildContext context) {
    return AnimatedBuilder(
        ...
        builder: (_, __) {
          final String era =
              StringUtils.getEra(controller.calculateYearFromScrollPos());
          final style =
  ...
  Widget _buildScrollingArea(double vtPadding, double size,
                ...
                Positioned.fill(
                  ...
                  child: FocusTraversalGroup(
                    child: WondersTimelineBuilder(
                        axis: Axis.vertical,
                        crossAxisGap:
                            max(6, (constraints.maxWidth - (120 * 3)) / 2),
